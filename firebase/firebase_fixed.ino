...
// WiFi Credentials
const char* ssid = "itel A05s";
const char* password = "12345678923";

// Firebase Configuration
const String FIREBASE_HOST = "iot11-lab-default-rtdb.firebaseio.com";
const String FIREBASE_AUTH = "TI2gmsSPlqxp1wUpVk28rVAmB681s5z4dBvj2JVJ";
